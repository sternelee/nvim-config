...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'copilot.vim', 'fidget.nvim', 'nvim-lightbulb', 'nvim_context_vt', 'indent-blankline.nvim', 'nvim-hlslens', 'rust-tools.nvim', 'git-blame.nvim', 'reach.nvim', 'marks.nvim', 'nvim-ts-rainbow', 'refactoring.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-peekup', 'nvim-spectre', 'vim-visual-multi', 'nvim-ts-autotag', 'smart-pairs', 'nvim-treesitter-refactor', 'nvim-treesitter-textobjects', 'move.nvim', 'vim-sandwich', 'neogen', 'vim-repeat'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
