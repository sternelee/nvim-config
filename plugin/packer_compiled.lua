...
_G.packer_plugins = {
  ...
  ["gruvbox-material"] = {
    ...
    url = "https://hub.xn--p8jhe.tw/sainnhe/gruvbox-material"
  },
  ["hop.nvim"] = {
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-textobjects', 'neogen', 'nvim-ts-autotag', 'nvim-peekup', 'better-escape.nvim', 'nvim-spectre', 'vim-sandwich', 'vim-repeat', 'vim-visual-multi', 'smart-pairs', 'nvim-treesitter-refactor'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'fidget.nvim', 'nvim-lightbulb', 'refactoring.nvim', 'editorconfig-vim', 'vim-speeddating', 'nvim-hlslens', 'copilot.vim', 'git-blame.nvim', 'nvim-ts-rainbow', 'nvim-bqf', 'splitjoin.vim', 'marks.nvim', 'indent-blankline.nvim', 'rust-tools.nvim', 'numb.nvim', 'nvim-treesitter-context', 'switch.vim', 'move.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
