...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lightbulb', 'indent-blankline.nvim', 'move.nvim', 'fidget.nvim', 'copilot.vim', 'reach.nvim', 'refactoring.nvim', 'rust-tools.nvim', 'nvim_context_vt', 'nvim-hlslens', 'git-blame.nvim', 'nvim-ts-rainbow', 'marks.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-repeat', 'smart-pairs', 'vim-sandwich', 'nvim-treesitter-refactor', 'nvim-peekup', 'nvim-ts-autotag', 'nvim-treesitter-textobjects', 'vim-visual-multi', 'neogen', 'nvim-spectre'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
