...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'marks.nvim', 'refactoring.nvim', 'reach.nvim', 'indent-blankline.nvim', 'nvim-bqf', 'git-blame.nvim', 'fidget.nvim', 'nvim-lightbulb', 'copilot.vim', 'switch.vim', 'vim-speeddating', 'nvim-hlslens', 'rust-tools.nvim', 'editorconfig-vim', 'move.nvim', 'nvim-treesitter-context', 'splitjoin.vim', 'numb.nvim', 'nvim-ts-rainbow'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-peekup', 'better-escape.nvim', 'nvim-spectre', 'vim-repeat', 'vim-visual-multi', 'smart-pairs', 'nvim-treesitter-refactor', 'nvim-treesitter-textobjects', 'nvim-ts-autotag', 'vim-sandwich', 'neogen'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
