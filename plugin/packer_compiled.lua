...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim_context_vt', 'numb.nvim', 'nvim-hlslens', 'move.nvim', 'splitjoin.vim', 'rust-tools.nvim', 'nvim-lightbulb', 'editorconfig-vim', 'indent-blankline.nvim', 'marks.nvim', 'nvim-bqf', 'nvim-ts-rainbow', 'git-blame.nvim', 'fidget.nvim', 'vim-speeddating', 'copilot.vim', 'reach.nvim', 'refactoring.nvim', 'switch.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'neogen', 'nvim-spectre', 'vim-repeat', 'vim-visual-multi', 'smart-pairs', 'nvim-peekup', 'nvim-treesitter-refactor', 'nvim-treesitter-textobjects', 'nvim-ts-autotag', 'vim-sandwich', 'better-escape.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
