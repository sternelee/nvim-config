...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-refactor', 'nvim-treesitter-textobjects', 'nvim-spectre', 'neogen', 'vim-repeat', 'vim-visual-multi', 'vim-sandwich', 'smart-pairs', 'nvim-peekup', 'nvim-ts-autotag'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lightbulb', 'move.nvim', 'indent-blankline.nvim', 'git-blame.nvim', 'editorconfig-vim', 'fidget.nvim', 'marks.nvim', 'nvim-treesitter-context', 'nvim-hlslens', 'numb.nvim', 'copilot.vim', 'rust-tools.nvim', 'nvim-ts-rainbow', 'refactoring.nvim', 'reach.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
