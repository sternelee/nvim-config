...
_G.packer_plugins = {
  ...
  ["distant.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/distant.nvim",
  ...
  ["indent-blankline.nvim"] = {
    config = { "\27LJ\2\nž\1\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\4\19use_treesitter\2\31show_current_context_start\2\25show_current_context\2\25space_char_blankline\6 \nsetup\21indent_blankline\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["pretty-fold.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/pretty-fold.nvim",
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-peekup', 'rust-tools.nvim', 'searchbox.nvim', 'diffview.nvim', 'distant.nvim', 'smart-pairs', 'git-blame.nvim', 'vgit.nvim', 'neogen'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-hlslens', 'nvim-ts-autotag', 'pretty-fold.nvim', 'codi.vim', 'fidget.nvim', 'glow.nvim', 'hop.nvim', 'nvim_context_vt', 'twilight.nvim', 'indent-blankline.nvim', 'vim-sandwich', 'nvim-bqf'}, { event = "BufRead *" }, _G.packer_plugins)]]
