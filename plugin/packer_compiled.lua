...
_G.packer_plugins = {
  ...
  ["gina.vim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/sternelee/.local/share/nvim/site/pack/packer/opt/gina.vim",
    url = "https://hub.xn--p8jhe.tw/lambdalisue/gina.vim"
  },
  ["git-blame.nvim"] = {
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'refactoring.nvim', 'git-blame.nvim', 'fidget.nvim', 'copilot.vim', 'reach.nvim', 'marks.nvim', 'nvim-hlslens', 'nvim-lightbulb', 'nvim-treesitter-context', 'numb.nvim', 'nvim-ts-rainbow', 'nvim-bqf', 'move.nvim', 'editorconfig-vim', 'rust-tools.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'neogen', 'nvim-treesitter-textobjects', 'vim-sandwich', 'vim-visual-multi', 'smart-pairs', 'vim-repeat', 'nvim-treesitter-refactor', 'nvim-ts-autotag', 'nvim-peekup', 'nvim-spectre'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
