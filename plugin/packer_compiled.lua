...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'neogen', 'nvim-treesitter-textobjects', 'nvim-peekup', 'nvim-spectre', 'vim-repeat', 'nvim-treesitter-refactor', 'smart-pairs', 'nvim-ts-autotag', 'vim-visual-multi', 'vim-sandwich'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'reach.nvim', 'refactoring.nvim', 'rust-tools.nvim', 'move.nvim', 'nvim-hlslens', 'git-blame.nvim', 'copilot.vim', 'fidget.nvim', 'indent-blankline.nvim', 'nvim-ts-rainbow', 'nvim-lightbulb', 'nvim_context_vt', 'marks.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
