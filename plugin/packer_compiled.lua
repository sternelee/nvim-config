...
_G.packer_plugins = {
  ...
  LuaSnip = {
    loaded = true,
    path = "/Users/sternelee/.local/share/nvim/site/pack/packer/start/LuaSnip",
    url = "https://hub.xn--p8jhe.tw/L3MON4D3/LuaSnip"
  },
  ["alpha-nvim"] = {
    loaded = true,
  ...
  cmp_luasnip = {
    loaded = true,
    path = "/Users/sternelee/.local/share/nvim/site/pack/packer/start/cmp_luasnip",
    url = "https://hub.xn--p8jhe.tw/saadparwaiz1/cmp_luasnip"
  },
  ["codi.vim"] = {
    commands = { "Codi" },
    loaded = false,
  ...
  neorg = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/sternelee/.local/share/nvim/site/pack/packer/opt/neorg",
    url = "https://hub.xn--p8jhe.tw/nvim-neorg/neorg"
  },
  ["nui.nvim"] = {
    loaded = true,
  ...
  ["nvim-docs-view"] = {
    ...
    config = { "\27LJ\2\n\1\0\0\6\0\t\1\0146\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0006\3\4\0009\3\5\0039\3\6\3'\5\a\0B\3\2\2\25\3\0\3=\3\b\2B\0\2\1K\0\1\0\nwidth\fcolumns\20nvim_get_option\bapi\bvim\1\0\1\rposition\nright\nsetup\14docs-view\frequire\6\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/sternelee/.local/share/nvim/site/pack/packer/opt/nvim-docs-view",
    url = "https://hub.xn--p8jhe.tw/amrbashir/nvim-docs-view"
  },
  ["nvim-gps"] = {
    loaded = true,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'copilot.vim', 'nvim-lightbulb', 'indent-blankline.nvim', 'nvim-hlslens', 'nvim-treesitter-context', 'nvim-bqf', 'vim-speeddating', 'git-blame.nvim', 'nvim-ts-rainbow', 'editorconfig-vim', 'fidget.nvim', 'splitjoin.vim', 'refactoring.nvim', 'marks.nvim', 'switch.vim', 'rust-tools.nvim', 'move.nvim', 'numb.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-sandwich', 'nvim-treesitter-textobjects', 'nvim-treesitter-refactor', 'vim-visual-multi', 'nvim-peekup', 'better-escape.nvim', 'nvim-spectre', 'vim-repeat', 'nvim-ts-autotag', 'smart-pairs', 'neogen'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
time([[Defining lazy-load event autocommands]], false)
vim.cmd("augroup END")
vim.cmd [[augroup filetypedetect]]
time([[Sourcing ftdetect script at: /Users/sternelee/.local/share/nvim/site/pack/packer/opt/neorg/ftdetect/norg.vim]], true)
vim.cmd [[source /Users/sternelee/.local/share/nvim/site/pack/packer/opt/neorg/ftdetect/norg.vim]]
time([[Sourcing ftdetect script at: /Users/sternelee/.local/share/nvim/site/pack/packer/opt/neorg/ftdetect/norg.vim]], false)
