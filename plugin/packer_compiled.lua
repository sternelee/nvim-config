...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-bqf', 'rust-tools.nvim', 'smart-pairs', 'yode-nvim', 'neogen', 'any-jump.vim', 'twilight.nvim', 'nvim-peekup', 'vim-sandwich', 'nvim-ts-autotag', 'codi.vim', 'fidget.nvim', 'nvim-hlslens', 'nvim-regexplainer', 'git-blame.nvim', 'glow.nvim', 'hop.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
