...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'smart-pairs', 'nvim-ts-autotag', 'vim-visual-multi', 'nvim-treesitter-refactor', 'vim-sandwich', 'nvim-peekup', 'nvim-spectre', 'neogen', 'vim-repeat', 'nvim-treesitter-textobjects'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-lightbulb', 'git-blame.nvim', 'fidget.nvim', 'copilot.vim', 'marks.nvim', 'rust-tools.nvim', 'refactoring.nvim', 'nvim_context_vt', 'nvim-bqf', 'nvim-hlslens', 'numb.nvim', 'reach.nvim', 'nvim-ts-rainbow', 'editorconfig-vim', 'move.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
