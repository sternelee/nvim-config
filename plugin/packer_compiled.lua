...
_G.packer_plugins = {
  ...
  ["marks.nvim"] = {
    config = { "\27LJ\2\n·\2\0\0\4\0\f\0\0176\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\0025\3\6\0=\3\a\0024\3\0\0=\3\b\0025\3\t\0=\3\n\0024\3\0\0=\3\v\2B\0\2\1K\0\1\0\rmappings\15bookmark_0\1\0\2\14virt_text\vsterne\tsign\bâš‘\23excluded_filetypes\18sign_priority\1\0\4\rbookmark\3\20\fbuiltin\3\b\nupper\3\15\nlower\3\n\18builtin_marks\1\5\0\0\6.\6<\6>\6^\1\0\4\22force_write_shada\1\vcyclic\2\21default_mappings\2\21refresh_interval\3ú\1\nsetup\nmarks\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-repeat', 'vim-visual-multi', 'smart-pairs', 'nvim-treesitter-textobjects', 'nvim-treesitter-refactor', 'vim-sandwich', 'nvim-ts-autotag', 'nvim-peekup', 'better-escape.nvim', 'nvim-spectre', 'neogen'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'reach.nvim', 'nvim-lightbulb', 'rust-tools.nvim', 'numb.nvim', 'nvim_context_vt', 'move.nvim', 'marks.nvim', 'indent-blankline.nvim', 'git-blame.nvim', 'fidget.nvim', 'copilot.vim', 'refactoring.nvim', 'vim-speeddating', 'switch.vim', 'splitjoin.vim', 'nvim-bqf', 'nvim-hlslens', 'nvim-ts-rainbow', 'editorconfig-vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
