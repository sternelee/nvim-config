...
_G.packer_plugins = {
  ...
  ["vim-diagon"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "C:\\Users\\Administrator\\AppData\\Local\\nvim-data\\site\\pack\\packer\\opt\\vim-diagon",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'fidget.nvim', 'refactoring.nvim', 'rust-tools.nvim', 'indent-blankline.nvim', 'nvim-dap-ui', 'nvim-lightbulb', 'marks.nvim', 'nvim-bqf', 'git-blame.nvim', 'copilot.vim', 'nvim_context_vt', 'nvim-hlslens', 'nvim-ts-rainbow', 'reach.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-ts-autotag', 'smart-pairs', 'vim-repeat', 'vim-sandwich', 'vim-visual-multi', 'nvim-peekup', 'neogen'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
