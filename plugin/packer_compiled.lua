...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-textobjects', 'nvim-peekup', 'nvim-spectre', 'vim-repeat', 'vim-visual-multi', 'smart-pairs', 'nvim-treesitter-refactor', 'nvim-ts-autotag', 'vim-sandwich', 'neogen'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter-context', 'rust-tools.nvim', 'refactoring.nvim', 'reach.nvim', 'move.nvim', 'nvim-lightbulb', 'nvim-hlslens', 'indent-blankline.nvim', 'editorconfig-vim', 'git-blame.nvim', 'numb.nvim', 'fidget.nvim', 'copilot.vim', 'nvim-ts-rainbow', 'marks.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
