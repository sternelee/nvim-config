...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-refactor', 'vim-visual-multi', 'nvim-peekup', 'better-escape.nvim', 'nvim-treesitter-textobjects', 'nvim-ts-autotag', 'neogen', 'vim-repeat', 'nvim-spectre', 'vim-sandwich', 'smart-pairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim_context_vt', 'numb.nvim', 'move.nvim', 'marks.nvim', 'editorconfig-vim', 'rust-tools.nvim', 'copilot.vim', 'nvim-bqf', 'git-blame.nvim', 'indent-blankline.nvim', 'nvim-lightbulb', 'fidget.nvim', 'switch.vim', 'splitjoin.vim', 'vim-speeddating', 'nvim-hlslens', 'refactoring.nvim', 'reach.nvim', 'nvim-ts-rainbow'}, { event = "BufRead *" }, _G.packer_plugins)]]
