...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-sandwich', 'neogen', 'nvim-treesitter-textobjects', 'nvim-peekup', 'nvim-ts-autotag', 'nvim-spectre', 'nvim-treesitter-refactor', 'vim-repeat', 'vim-visual-multi', 'smart-pairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter-context', 'rust-tools.nvim', 'refactoring.nvim', 'nvim-lightbulb', 'numb.nvim', 'marks.nvim', 'indent-blankline.nvim', 'reach.nvim', 'git-blame.nvim', 'fidget.nvim', 'nvim-hlslens', 'move.nvim', 'copilot.vim', 'nvim-ts-rainbow', 'editorconfig-vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
