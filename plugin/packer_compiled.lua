...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-ts-autotag', 'smart-pairs', 'vim-sandwich', 'neogen', 'nvim-peekup', 'vim-repeat', 'vim-visual-multi'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim_context_vt', 'nvim-lightbulb', 'fidget.nvim', 'reach.nvim', 'refactoring.nvim', 'git-blame.nvim', 'rust-tools.nvim', 'copilot.vim', 'indent-blankline.nvim', 'nvim-hlslens', 'marks.nvim', 'nvim-bqf', 'nvim-ts-rainbow'}, { event = "BufRead *" }, _G.packer_plugins)]]
