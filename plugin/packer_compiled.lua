...
_G.packer_plugins = {
  ...
  ["vgit.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/sternelee/.local/share/nvim/site/pack/packer/opt/vgit.nvim",
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'hop.nvim', 'indent-blankline.nvim', 'nvim-bqf', 'vim-sandwich', 'twilight.nvim', 'fidget.nvim', 'nvim-hlslens', 'nvim_context_vt', 'glow.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vgit.nvim', 'neogen', 'diffview.nvim', 'rust-tools.nvim', 'git-blame.nvim', 'smart-pairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
