...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-treesitter-textobjects', 'neogen', 'nvim-spectre', 'nvim-ts-autotag', 'smart-pairs', 'vim-sandwich', 'vim-visual-multi', 'nvim-peekup', 'better-escape.nvim', 'vim-repeat'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-ts-rainbow', 'editorconfig-vim', 'rust-tools.nvim', 'nvim-lightbulb', 'nvim-bqf', 'git-blame.nvim', 'marks.nvim', 'fidget.nvim', 'refactoring.nvim', 'indent-blankline.nvim', 'numb.nvim', 'copilot.vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
