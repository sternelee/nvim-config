...
_G.packer_plugins = {
  ...
  ["splitjoin.vim"] = {
    loaded = true,
    path = "/Users/sternelee/.local/share/nvim/site/pack/packer/start/splitjoin.vim",
    url = "https://hub.xn--p8jhe.tw/AndrewRadev/splitjoin.vim"
  },
  ["switch.vim"] = {
    loaded = true,
    path = "/Users/sternelee/.local/share/nvim/site/pack/packer/start/switch.vim",
  ...
  ["vim-speeddating"] = {
    loaded = true,
    path = "/Users/sternelee/.local/share/nvim/site/pack/packer/start/vim-speeddating",
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-visual-multi', 'smart-pairs', 'nvim-treesitter-refactor', 'nvim-ts-autotag', 'vim-sandwich', 'nvim-treesitter-textobjects', 'neogen', 'nvim-peekup', 'vim-repeat', 'nvim-spectre'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-hlslens', 'nvim-ts-rainbow', 'rust-tools.nvim', 'nvim_context_vt', 'refactoring.nvim', 'reach.nvim', 'nvim-lightbulb', 'fidget.nvim', 'copilot.vim', 'numb.nvim', 'move.nvim', 'marks.nvim', 'indent-blankline.nvim', 'git-blame.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
